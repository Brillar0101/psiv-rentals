      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <View style={styles.content}>
            ...
            <View style={styles.starsContainer}>
              {[1, 2, 3, 4, 5].map((star) => (
                <TouchableOpacity key={star} onPress={() => handleStarPress(star)} style={styles.starBtn}>
                  <Text style={[styles.starIcon, star <= rating && styles.starIconFilled]}>{star <= rating ? '⭐' : '☆'}</Text>
                </TouchableOpacity>
              ))}
            </View>
            {rating > 0 && (
          ...
          <View style={styles.benefitsCard}>
            ...
            <View style={styles.benefitRow}><Text style={styles.benefitIcon}>✓</Text><Text style={styles.benefitText}>Help us improve the app</Text></View>
            <View style={styles.benefitRow}><Text style={styles.benefitIcon}>✓</Text><Text style={styles.benefitText}>Share your experience with others</Text></View>
            <View style={styles.benefitRow}><Text style={styles.benefitIcon}>✓</Text><Text style={styles.benefitText}>Support a local business</Text></View>
          </View>
...
const styles = StyleSheet.create({
  ...
  ratingLabel: { fontSize: SIZES.h4, fontWeight: FONT_WEIGHTS.bold, color: COLORS.text, marginBottom: SIZES.lg },
  starsContainer: { flexDirection: 'row', marginBottom: SIZES.md },
  starBtn: { padding: SIZES.sm },
  starIcon: { fontSize: 48, color: COLORS.border },
  starIconFilled: { color: COLORS.warning },
  ...
  feedbackTitle: { fontSize: SIZES.h4, fontWeight: FONT_WEIGHTS.bold, color: COLORS.text, marginBottom: SIZES.md },
  ...
  benefitsTitle: { fontSize: SIZES.body, fontWeight: FONT_WEIGHTS.bold, color: COLORS.text, marginBottom: SIZES.md },
  benefitRow: { flexDirection: 'row', alignItems: 'center', marginBottom: SIZES.sm },
  benefitIcon: { fontSize: 16, color: COLORS.success, marginRight: SIZES.sm, width: 20 },
