// src/screens/payment/ApplePayScreen.tsx
    ...
    <View style={styles.container}>
      ...
      <View style={styles.content}>
        <View style={styles.iconContainer}>
          <Icon name="smartphone" size={64} color={COLORS.primary} />
        </View>
        <Text style={styles.subtitle}>Pay with Apple Pay</Text>
...
const styles = StyleSheet.create({
  ...
  subtitle: { fontSize: SIZES.h4, fontFamily: FONTS.semiBold, color: COLORS.text, marginBottom: SIZES.sm },
